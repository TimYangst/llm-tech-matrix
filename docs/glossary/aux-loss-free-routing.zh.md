...
| GLM-5.2                                 | `topk_method='noaux_tc'` 配 sigmoid 打分，256 专家 top-8 + 1 共享，`routed_scaling_factor=2.5`——与 GLM-5 / 5.1 一致。新增 `moe_router_dtype='float32'`，无论模型是 bf16 都把路由器钉在 fp32。                                                                                                                                                                                                                                                                         |
