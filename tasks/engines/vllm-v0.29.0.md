...
## Schema notes from the pilot

- **Reshaped before landing** (driven by `sglang-v0.5.19`): the pilot put
...
- **Non-native loading paths** (Transformers backend, plugins) are out of engine schema v1. Revisit if absent
